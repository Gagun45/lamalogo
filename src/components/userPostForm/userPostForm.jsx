...
export default function UserPostForm({ userId }) {
  ...
  return (
    <form action={formAction} className={styles.container}>
      ...
      <textarea placeholder='Description' name='desc' rows={5} value={description} onChange={(e) => setDescription(e.target.value)} />
      <button>Add</button>
      {state &&
